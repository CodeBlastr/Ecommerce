 ...
 */
    public function _shipmentAndPayment($data) {
        ...
        if (isset($data['Meta']))
            $shipmentAndPayment['OrderShipment'] = array_merge($shipmentAndPayment['OrderShipment'], $data['Meta']);
        ...
        if (isset($data['Meta']))
            $shipmentAndPayment['OrderPayment'] = array_merge($shipmentAndPayment['OrderPayment'], $data['Meta']);
